...
func (c *UserEntityController) SignUp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		HyperText.HttpTestResponse(w, http.StatusBadRequest, "wrong-body")
	...
	if err != nil {
		HyperText.HttpTestResponse(w, http.StatusBadRequest, "error-database")
		//HyperText.HttpErrorResponse(w, http.StatusBadRequest, err)
		return
	}

	HyperText.HttpTestResponse(w, http.StatusOK, "success")
	//HyperText.HttpErrorResponse(w, http.StatusOK, HyperText.CustomResponses["success-insert"])
	return
}
...
func (c *UserEntityController) Login(w http.ResponseWriter, r *http.Request) {
	...
	HyperText.HttpTestResponse(w, http.StatusOK, "success")
	//HyperText.HttpResponse(w, http.StatusOK, "success-Login")
	return
}
...
func (c *UserEntityController) UpdateSingle(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		HyperText.HttpTestResponse(w, http.StatusBadRequest, "wrong-validation")
		//HyperText.HttpErrorResponse(w, http.StatusBadRequest, err)
		return
	}
	...
	if err != nil {
		HyperText.HttpTestResponse(w, http.StatusBadRequest, "error-database")
		//HyperText.HttpErrorResponse(w, http.StatusBadRequest, "error-update")
		return
	}

	HyperText.HttpTestResponse(w, http.StatusOK, "success")
	//HyperText.HttpResponse(w, http.StatusOK, "success-update")
	return
}
...
func (c *UserEntityController) Disable(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		HyperText.HttpTestResponse(w, http.StatusBadRequest, "error-database")
		//HyperText.HttpErrorResponse(w, http.StatusBadRequest, "error-disable")
		return
	}

	HyperText.HttpTestResponse(w, http.StatusOK, "success")
	//HyperText.HttpResponse(w, http.StatusOK, "success-disabled")
	return
}
...
func (c *UserEntityController) GetUnique(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		HyperText.HttpTestResponse(w, http.StatusBadRequest, "error-database")
		//HyperText.HttpErrorResponse(w, http.StatusBadRequest, "not-found-entity")
		return
	}
	HyperText.HttpTestResponse(w, http.StatusOK, "success")
...
func (c *UserEntityController) GetAllEnabledWhile(w http.ResponseWriter, r *http.Request) {
	...
	_, err := c.UserEntityRepository.GetAllEnabledWhileUserEntities(position, value, ues)
	//ues, err := c.UserEntityRepository.GetAllEnabledWhileUserEntities(position, value, ues)

	if err != nil {
		HyperText.HttpTestResponse(w, http.StatusBadRequest, "error-database")
		//HyperText.HttpErrorResponse(w, http.StatusBadRequest, "empty-database")
		return
	}
...
func (c *UserEntityController) GetAllEnabled(w http.ResponseWriter, r *http.Request) {
	...
	_, err := c.UserEntityRepository.GetAllEnabledUserEntities(ues)
...
func (c *UserEntityController) GetAll(w http.ResponseWriter, r *http.Request) {
	...
	_, err := c.UserEntityRepository.GetAllUserEntities(ues)
...
func (c *UserEntityController) Delete(w http.ResponseWriter, r *http.Request) {
	...
	HyperText.HttpTestResponse(w, http.StatusOK, "success")
	//HyperText.HttpResponse(w, http.StatusOK, "success-Delete")
	return
}
